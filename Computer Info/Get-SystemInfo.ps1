...
[string]$Path = "\\chwpnetapp06\homedirs$\bstevens007\IIS\SystemInfo\systemreport.htm",
#set your own default graphic or delete default value
[string]$ImagePath = "C:\Users\bstevens007\Pictures\DignityHealthLogo.png"
)
 
#region helper functions
 
Function Get-SystemInfo123 {
[cmdletbinding()]
...
$fragments+= Get-SystemInfo123 -Computername $computername| ConvertTo-Html -Fragment -As List
$fragments+="</div>"
