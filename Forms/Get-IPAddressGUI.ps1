Function Get-IPAddressGUI {
##### BEGIN Helper Functions ######

function Test-ValidIPAddressGUI([string]$IPAddress) {
...
# Original Author: Brandon Stevens
...
$GUIPSInstance.AddScript({
    ...
    $XAMLInput = @"
<Window x:Name="XamlMainWindow" x:Class="Test-ValidIPAddressGUIForXMLOnly.MainWindow"
        xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        xmlns:d="http://schemas.microsoft.com/expression/blend/2008"
        xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006"
        xmlns:local="clr-namespace:Test-ValidIPAddressGUIForXMLOnly"
        mc:Ignorable="d"
        Title="Brandon Stevens IP Address GUI" Height="525" Width="525" WindowStartupLocation="CenterScreen" SizeToContent="Height" MinHeight="600" MinWidth="625" MaxHeight="800">
