Function Get-TeamsGroupsActivityReport
{
...
# Created 27-November-2020  Brandon Stevens
...
$Report = [System.Collections.Generic.List[Object]]::new(); $ReportFile = "~/Downloads/GroupsActivityReport.html"
$CSVFile = "~/Downloads/GroupsActivityReport.csv"
$htmlhead="<html>
	   <style>
