Function Get-OneDriveQuotas
{
# Retrieve a list of all OneDrive for Business sites within the organisation
#
# Requires the Sharepoint Online PowerShell module to be installed
#

# The name of your Office 365 organization
# This can be found in your Sharepoint URL before the '-my', eg: https://anomalixdefault-my.sharepoint.com/
$spoTenantName='https://anomalixdefault-my.sharepoint.com/'
