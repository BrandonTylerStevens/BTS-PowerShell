Function Find-PotentialDirectoryProblems
{
...
$Report | Sort User | Export-CSV ~/downloads/DirectoryIssues.csv -NoTypeInformation
Write-Host " "
Write-Host "An output file containing details of missing directory properties is available in 	~/downloads/DirectoryIssues.csv"
}